...
const itemLinkList =  ["홈페이지", "포탈", "학사서비스", "아주Bb", "전자출석부", "학사일정", "중앙도서관", "학과 홈페이지", "나의 학과", "사이트맵", "공지사항", "수강신청", "요람", "아주 허브", "기숙사", "교내식당", "대학기구", "교내 전화번호", "대학일자리센터", "LINC+ 사업단", "국제협력처", "수학 웹과제", "과학 웹과제", "에브리타임", "과제 카페"];
const itemDepartmentList = ["기계공학과", "산업공학과", "화학공학과", "첨단신소재공학과", "응용화학생명공학과", "환경안전공학과", "건설시스템공학과", "교통시스템공학과", "건축학과", "융합시스템공학과", "AI모빌리티공학과", "전자공학과", "지능형반도체공학과", "소프트웨어학과", "사이버보안학과", "미디어학과", "국방디지털융합학과", "인공지능융합학과", "수학과", "물리학과", "화학과", "생명과학과", "경영학과", "e-비즈니스학과", "금융공학과", "글로벌경영학과", "국어국문학과", "영어영문학과", "불어불문학과", "사학과", "문화콘텐츠학과", "경제학과", "행정학과", "심리학과", "사회학과", "정치외교학과", "스포츠레저학과", "의학과", "간호학과", "약학과", "다산학부대학", "국제학부"];
...
window.addEventListener('load', function(){
    ...
    button.addEventListener('click', function() {
        ...
        chrome.storage.local.set({Department: data}, function() { 
...
function itemLinkOptions(buttonLinkElement, itemLinkList, num) {
    for (let item of itemLinkList) {
        ...
        //버튼 클릭시 바로가기 설정 동기화
        button.addEventListener('click', function() {
            chrome.storage.local.set({[`Link${num}`] : item}, function() {
